...
export function elulDetails(state: ElulState): string[] {
  return [
    'אֱלוּל — ראשי תיבות של ״אֲנִי לְדוֹדִי וְדוֹדִי לִי״ (שיר השירים ו, ג).',

    'ודודי, הוא ה׳ יתברך, ואני, אלו ישראל. ובחודש אלול מתקיים הפסוק, שאנו לה׳, וה׳ הוא לנו. כלומר, ישנה קירבה מיוחדת בין ישראל לה׳ בימים הללו.',

    'מקובל לחשוב, כי בחודש אלול מוטלת חובה על כל יהודי להשתדל לעסוק בתשובה ולקרב את עצמו לעבודת ה׳. נכונים הדברים. אך אל לנו לשכוח, כי גם מן הצד השני, כביכול, הקדוש ברוך הוא מקרב את עצמו אלינו בחודש זה, ובמידת הרחמים השולטת בימים הללו, הוא ממהר לסלוח ולרחם על ברואיו השבים אליו. וכמו שאמרו במדרש, ״אני לדודי ודודי לי״ — ה׳ אומר לישראל, חלקי אתם, וישראל אומרים לה׳, חלקי ה׳.',
